...
export default function Waves() {
  ...
  return (
    <motion.div
      ...
      className='flex justify-center items-center h-[100vh] bg-gradient-to-b from-[#000b1e] via-[#21466b] to-[#385f70] border-t-2 border-white w-screen absolute top-[102vh]'
    >
      <div
